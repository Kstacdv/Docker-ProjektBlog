 ...
 */
final class Version20251214115338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id SERIAL NOT NULL, title VARCHAR(80) NOT NULL, created_at DATE NOT NULL, deleted_at DATE DEFAULT NULL, tags VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, article_body TEXT DEFAULT NULL, date_added DATE NOT NULL, PRIMARY KEY(id))');
